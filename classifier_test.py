# for various classifier
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 15 10:58:52 2024
...
nb_pipeline = Pipeline([
    ('NBCV', feature_extraction.countV),
...
logR_pipeline = Pipeline([
    ('LogRCV', feature_extraction.countV),
...
svm_pipeline = Pipeline([
    ('svmCV', feature_extraction.countV),
    ('svm_clf', svm.LinearSVC())
])

svm_pipeline.fit(preprocess.train_news['Statement'], preprocess.train_news['Label'])
predicted_svm = svm_pipeline.predict(preprocess.test_news['Statement'])
np.mean(predicted_svm == preprocess.test_news['Label'])

"""
# using SVM Stochastic Gradient Descent on hinge loss
sgd_pipeline = Pipeline([
    ('svm2CV', feature_extraction.countV),
    ('svm2_clf', SGDClassifier(loss='hinge', penalty='l2', alpha=1e-3, n_iter=5))
])

sgd_pipeline.fit(preprocess.train_news['Statement'], preprocess.train_news['Label'])
predicted_sgd = sgd_pipeline.predict(preprocess.test_news['Statement'])
np.mean(predicted_sgd == preprocess.test_news['Label'])
"""

# random forest
random_forest = Pipeline([
    ('rfCV', feature_extraction.countV),
...
print("*******Bag of words confusion matrix and F1 scores (before n-grams)*******")
# ========================================================================================
# Bag of words confusion matrix and F1 scores (before n-grams)
...
nb_pipeline_ngram = Pipeline([
    ('nb_tfidf', feature_extraction.tfidf_ngram),
    ('nb_clf', MultinomialNB())])
...
logR_pipeline_ngram = Pipeline([
    ('LogR_tfidf', feature_extraction.tfidf_ngram),
...
svm_pipeline_ngram = Pipeline([
    ('svm_tfidf', feature_extraction.tfidf_ngram),
    ('svm_clf', svm.LinearSVC())
])

svm_pipeline_ngram.fit(preprocess.train_news['Statement'], preprocess.train_news['Label'])
predicted_svm_ngram = svm_pipeline_ngram.predict(preprocess.test_news['Statement'])
np.mean(predicted_svm_ngram == preprocess.test_news['Label'])

# sgd classifier
sgd_pipeline_ngram = Pipeline([
    ('sgd_tfidf', feature_extraction.tfidf_ngram),
    ('sgd_clf', SGDClassifier(loss='hinge', penalty='l2', alpha=1e-3, n_iter=5))
])

sgd_pipeline_ngram.fit(preprocess.train_news['Statement'], preprocess.train_news['Label'])
predicted_sgd_ngram = sgd_pipeline_ngram.predict(preprocess.test_news['Statement'])
np.mean(predicted_sgd_ngram == preprocess.test_news['Label'])

# random forest classifier
random_forest_ngram = Pipeline([
    ('rf_tfidf', feature_extraction.tfidf_ngram),
...
print("*******Bag of words confusion matrix and F1 scores (with n-grams)*******")
# ========================================================================================
# n-grams & tfidf confusion matrix and F1 scores (with n-grams)
...
print(classification_report(preprocess.test_news['Label'], predicted_svm_ngram))
print(classification_report(preprocess.test_news['Label'], predicted_sgd_ngram))
print(classification_report(preprocess.test_news['Label'], predicted_rf_ngram))

preprocess.test_news['Label'].shape
print("preprocess.test_news['Label'].shape: ", preprocess.test_news['Label'].shape)
...
print(metrics.classification_report(preprocess.test_news['Label'], predicted_rf_final))
...
# accuracy = 0.62
print(metrics.classification_report(preprocess.test_news['Label'], predicted_LogR_final))
